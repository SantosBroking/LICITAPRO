        ...
        projectsVisibles.map(p => {
          ...
          return h('div', { key:p.id, onClick:()=>onNav('project_detail',p.id),
            ...
            h('div', { style:{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:8, marginBottom:4 } },
              h('div', { style:{ fontWeight:500, fontSize:13, flex:1, minWidth:0, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap', textTransform:'uppercase' } },
                p.name, p.folioProyecto && h('div', { style:{ fontSize:10, color:'var(--t3)', textTransform:'none', fontWeight:400 } }, p.folioProyecto)),
