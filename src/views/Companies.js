  ...
  return h('div', null,
    ...
    h('div', { className:'mob-1col', style:{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16, marginBottom:16 } },
      h('div', { className:'card' },
        ...
        // Representante legal (firma en documentos membretados)
        h('div', { style:{ marginTop:4, marginBottom:4, paddingTop:14, borderTop:'.5px solid var(--b3)' } },
          h('div', { style:{ fontSize:13, fontWeight:600, marginBottom:4 } }, 'Representante legal'),
          h('div', { style:{ fontSize:11, color:'var(--t3)', marginBottom:10 } }, 'Esta persona firma en los documentos membretados de esta empresa.'),
          h('div', { style:{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 } },
            h(Inp, { label:'Nombre del representante', value:c.representanteLegal||'', onChange:v=>set('representanteLegal',v), placeholder:'Lic. Juan Pérez' }),
            h(Inp, { label:'Cargo', value:c.cargoRepresentante||'', onChange:v=>set('cargoRepresentante',v), placeholder:'Apoderado legal' }),
          ),
        ),
