...
export const CATALOG_PRODUCTS = [
  ...
  {id:'01-002',cat:'01 Imagen',sub:'Pintura',        nom:'Pintura institucional',             desc:'Pintura vehicular con colores y lineamientos oficiales del proyecto, apegado al manual de identidad.',                prov:'Local', vis:true},
  {id:'01-003',cat:'01 Imagen',sub:'Vinil',          nom:'Calcas / vinil',                    desc:'Viniles y calcas de identificación para uso exterior vehicular, apegado al manual de identidad.',                            prov:'Local', vis:true},
  {id:'01-004',cat:'01 Imagen',sub:'Identificación', nom:'Números económicos',                desc:'Numeración en vinil para control e identificación operativa, apegado al manual de identidad.',                   prov:'Local', vis:true},
  ...
  // ── 02 FIERROS ───────────────────────────────────────────────
  {id:'02-006',cat:'02 Fierros',sub:'Estructura',    nom:'Roll bar',                          desc:'Estructura tubular para caja de pickup, fabricada en acabado resistente, apegado al manual de identidad.',                                  prov:'Taller',vis:true},
  {id:'02-007',cat:'02 Fierros',sub:'Protección',    nom:'Burrera central metálica',          desc:'Defensa frontal metálica para protección de la unidad, apegado al manual de identidad.',                         prov:'Taller',vis:true},
  {id:'02-008',cat:'02 Fierros',sub:'Protección',    nom:'Burrera central metálica sedan',    desc:'Defensa frontal metálica para sedán operativo o patrulla, apegado al manual de identidad.',                                prov:'Taller',vis:true},
  {id:'02-009',cat:'02 Fierros',sub:'Protección',    nom:'Burrera central metálica van',      desc:'Defensa frontal metálica para van o unidad de transporte, apegado al manual de identidad.',                                  prov:'Taller',vis:true},
  {id:'02-010',cat:'02 Fierros',sub:'Protección',    nom:'Burrera central silicón',           desc:'Defensa frontal con acabado tipo silicón para uso urbano, apegado al manual de identidad.',                       prov:'Taller',vis:true},
  {id:'02-011',cat:'02 Fierros',sub:'Protección',    nom:'Defensa trasera antiderrapante',    desc:'Defensa o escalón trasero con superficie antiderrapante, apegado al manual de identidad.',              prov:'Taller',vis:true},
  {id:'02-012',cat:'02 Fierros',sub:'Protección',    nom:'Protector de ventana tipo rejilla', desc:'Protector metálico para ventanas de unidades policiales, apegado al manual de identidad.',                   prov:'Taller',vis:true},
  {id:'02-013',cat:'02 Fierros',sub:'Interior',      nom:'Mampara Divisora',                  desc:'Mampara interior para separar áreas de la unidad, apegado al manual de identidad.',                   prov:'Taller',vis:true},
  {id:'02-014',cat:'02 Fierros',sub:'Interior',      nom:'Banca central metálica',            desc:'Banca metálica para área posterior de pickup o patrulla, apegado al manual de identidad.',         prov:'Taller',vis:true},
  {id:'02-015',cat:'02 Fierros',sub:'Soporte',       nom:'Soporte para radio',                desc:'Base metálica para montaje seguro de radio, apegado al manual de identidad.',                               prov:'Taller',vis:true},
  {id:'02-016',cat:'02 Fierros',sub:'Adaptación',    nom:'Lona con ventanas laterales',       desc:'Lona para caja de pickup con ventanas laterales, apegado al manual de identidad.',                           prov:'Taller',vis:true},
  {id:'02-017',cat:'02 Fierros',sub:'Adaptación',    nom:'Adaptación especial',               desc:'Modificación metálica especial según requerimiento del proyecto, apegado al manual de identidad.',               prov:'Taller',vis:true},
  ...
  {id:'07-049',cat:'07 Consumibles',sub:'General',   nom:'Consumibles generales',             desc:'Materiales menores para instalación y adaptación, apegado al manual de identidad.',                                prov:'Proveedor',vis:true},
  {id:'07-050',cat:'07 Consumibles',sub:'Extra',     nom:'Extras',                            desc:'Conceptos adicionales requeridos por proyecto, apegado al manual de identidad.',                                      prov:'Proveedor',vis:true},

  // ── 08 MANO DE OBRA ──────────────────────────────────────────
  {id:'08-050',cat:'08 Mano de obra',sub:'Servicio', nom:'Mano de obra general',              desc:'Servicio de instalación e integración general de equipos, apegado al manual de identidad.',                                prov:'Interna',vis:false},
